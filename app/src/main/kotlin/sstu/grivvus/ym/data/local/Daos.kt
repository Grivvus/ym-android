...
interface TrackAlbumDao {
    ...
    @Query("DELETE FROM track_album_cross_ref WHERE album_id IN (:albumIds)")
    suspend fun deleteForAlbums(albumIds: Collection<Long>)
...
interface ArtistDao {
    ...
    @Query("SELECT * FROM artist ORDER BY name ASC, remote_id ASC")
...
interface PlaylistTrackDao {
    ...
    @Upsert
    suspend fun upsert(ref: PlaylistTrackCrossRef)
